...
// Solution 2: Shared Memory Reduction with Interleaved Addressing
// Approach: Each block reduces to one value using shared memory, then recursively reduce partial results
