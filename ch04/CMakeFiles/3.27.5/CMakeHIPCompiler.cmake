set(CMAKE_HIP_COMPILER "/opt/rocm-6.3.0/lib/llvm/bin/clang++")
...
set(CMAKE_HIP_COMPILER_ROCM_ROOT "/opt/rocm-6.3.0/lib/llvm/bin/../../..")
set(CMAKE_HIP_COMPILER_ROCM_LIB "/opt/rocm-6.3.0/lib/llvm/bin/../../../lib")
...
set(CMAKE_HIP_IMPLICIT_INCLUDE_DIRECTORIES "/opt/rocm-6.3.0/include;/opt/rocm-6.3.0/lib/llvm/lib/clang/18/include/cuda_wrappers;/usr/include/c++/11;/usr/include/x86_64-linux-gnu/c++/11;/usr/include/c++/11/backward;/opt/rocm-6.3.0/lib/llvm/lib/clang/18/include;/usr/local/include;/usr/include/x86_64-linux-gnu;/usr/include")
set(CMAKE_HIP_IMPLICIT_LINK_LIBRARIES "amdhip64;stdc++;m;gcc_s;c;gcc_s")
set(CMAKE_HIP_IMPLICIT_LINK_DIRECTORIES "/usr/lib/gcc/x86_64-linux-gnu/11;/usr/lib64;/lib/x86_64-linux-gnu;/lib64;/usr/lib/x86_64-linux-gnu;/lib;/usr/lib;/opt/rocm-6.3.0/lib")
set(CMAKE_HIP_IMPLICIT_LINK_FRAMEWORK_DIRECTORIES "")

set(CMAKE_HIP_RUNTIME_LIBRARY_DEFAULT "SHARED")

set(CMAKE_AR "/usr/bin/ar")
set(CMAKE_HIP_COMPILER_AR "/opt/rocm-6.3.0/lib/llvm/bin/llvm-ar")
set(CMAKE_RANLIB "/usr/bin/ranlib")
set(CMAKE_HIP_COMPILER_RANLIB "/opt/rocm-6.3.0/lib/llvm/bin/llvm-ranlib")
